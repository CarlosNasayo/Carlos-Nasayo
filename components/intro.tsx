...
export default function Intro() {
  return (
    <section className="mb-29 max-w-[50rem]
    text-center sm:mb-0">
      ...
      <motion.p className="mb-10 mt-4 text-2xl px-4 font-medium !leading-[1.5] sm:text-4xl"
      ...
      >
        ...
        building <span className="italic">apps frotned and backend</span>. My focus is{" "}
        <span className="">frontend and backend</span>.
      </motion.p>
      ...
      >
        <Link href="#contact" className=" group bg-gray-900 text-white px-7
         ...
         transition cursor-pointer border border-black/10" href="/CarlosNasayo.pdf" download>Download CV <HiDownload className="opacity-60 group-hover:translate-y-1 transition"/>
         </a>
         ...
         <a className="bg-white p-4 text-gray-700
          ...
          transition cursor-pointer border border-black/10 " href="https://co.linkedin.com/in/carlos-mario-nasay%C3%B3-valverde-abb717221" target="_blank">
          <BsLinkedin/>
         </a>
         ...
         <a className="bg-white p-4 text-gray-700
          ...
          transition cursor-pointer border border-black/10" href="https://github.com/CarlosNasayo" target="_blank">
          <FaGithubSquare/>
         </a>
